 ...
 * @param <I> the type of the {@code Entity} identifier.
 */
public interface Entity<E extends Entity, I> {
     ...
     *
     * @param otherEntity the other {@code Entity} to compare with.
     * @return {@code true} if the identities are the same, regardless of the other attributes.
     */
    boolean hasSameIdentityAs( E otherEntity );
